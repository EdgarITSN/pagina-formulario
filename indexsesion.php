...
<body>
	<br> <center><div class="tit"><h2 >Inicio de sesión</h2><br><br>
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 14pt"><b>Correo: </b></label></td>
			<td width=80> <input class="form-group has-success" type="text" name="mail"></td></tr><br>
		<tr><td><label style="font-size: 14pt"><b>Contraseña: </b></label></td>
			<td witdh=80> <input type="password" name="pass"></td></tr><br>
		<tr><td></td>
